...
class SchedulerRuntimeCheckerMixin:
    ...
    def on_idle(self: Scheduler):
        ...
        # separate from IdleSleeper because every TP/PP rank owns an independent
        # GPU allocator, while only the ingress rank owns the ZMQ poller.
        # Logical KV/Radix/Mamba pools remain intact.
        ...
        # CPU/ZMQ sleeping remains ingress-rank-only. GPU allocator trimming is
        # all-rank and does not depend on --sleep-on-idle.
